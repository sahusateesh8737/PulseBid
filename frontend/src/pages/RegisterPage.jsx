...
import { Gavel, Mail, Lock, ShieldCheck, User, ArrowRight, Shield, Zap, Key, Building2, Contact } from 'lucide-react';
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div className="flex items-start gap-3 pt-2 pb-2">
              <div className="mt-0.5">
                <div className="w-4 h-4 rounded border border-[#2A2A2A] bg-[#0D0D0D] flex items-center justify-center cursor-pointer">
                  {/* Assuming un-checked state by default, checked can use a small checkmark */}
                </div>
              </div>
